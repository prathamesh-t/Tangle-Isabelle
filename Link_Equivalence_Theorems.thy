...
lemma test_0: "(make_vert_block (n+1)) = (cement vert)⊗(make_vert_block n)" 
                   using test_00 append_blocks_Nil by metis


lemma test_1: "(make_vert_block (n+1)) = (make_vert_block n)⊗(cement vert)" 
  apply(induct_tac n)
  apply(auto)
...
theorem linkrel_doublecompress_below:
 ...
 have subresult_equiv1: 
 "(linkrel_equiv  ((Abs_diagram (x1∘(basic z4)∘(basic y1)∘z1))) 
           (Abs_diagram (x1∘(basic y1)∘z1)))" 
           using r_into_rtranclp subresult_compress1 linkrel_equiv_def linkrel_def  
           linkrel_compress_def
                     by (metis)
...
(*step2*)
 ...
 have step2_subresult0: "(make_vert_block (?k+1)) = ((cement vert)⊗(make_vert_block ?k))" 
  apply(simp)
  done
 have step2_subresult1:"?z4 = (cement vert)⊗(make_vert_block ?k)" using C step2_subresult0 by auto
 ...
 have step2_subresult9: "linkrel (Abs_diagram ((?x2) ∘(basic ((cement cup)⊗(cement vert)⊗w4))
                             ∘(basic ((cement vert)⊗(cement cap)⊗w4))∘z1)) 
              (Abs_diagram ((?x2) ∘(basic ((cement vert)⊗w4))∘(basic ((cement vert)⊗w4))∘z1))"
               using step2_subresult8 by auto 
 have step2_equiv1: "linkrel_equiv (Abs_diagram (x1∘basic y1∘(basic ((cement cup)⊗(cement vert)⊗w4))
                              ∘(basic ((cement vert)⊗(cement cap)⊗w4))∘z1)) 
              (Abs_diagram (x1∘basic y1 ∘(basic ((cement vert)⊗w4))∘(basic ((cement vert)⊗w4))∘z1))"
               using step2_subresult9 compose_leftassociativity r_into_rtranclp 
               linkrel_equiv_def
                     by metis
 have step2: "linkrel_equiv (Abs_diagram (x1∘basic y1∘(basic ((cement cup)⊗?z4))∘(basic ((cement vert)⊗(cement cap)⊗w4))∘z1)) 
...
(*step 3*)
 ...
 have step3_preliminary2 : 
  "count ((cup)#((cement cup)⊗w4)) = (fst (brickcount (cup)) + fst (count ((cement cup)⊗w4)),
  snd (brickcount (cup)) + snd (count ((cement cup)⊗w4)))"
 using count_def by auto
 have step3_preliminary3: 
  "((cement cup)⊗((cement vert)⊗w4)) = cup#((cement vert)⊗w4)" using append_blocks_Nil by metis
 have step3_subresult0 : 
   "fst (count ((cup)#((cement cup)⊗w4))) =  (fst (brickcount (cup)) + fst (count ((cement cup)⊗w4)))"
 ...
 using step3_preliminary5  step3_preliminary6 
  by auto
 have step3_subresult1 :"fst (wall_count (basic ((cement cup)⊗(cement vert)⊗w4))) 
 ...
 have step3_subresult2: "fst (wall_count (basic ((cement vert)⊗w4))) = snd (count y1)" 
               using w_subst step2_subresult1 subresult8 by auto
 have step3_subresult3: "fst (wall_count (basic ((cement cup)⊗(cement vert)⊗w4))) = snd (count y1)" 
               using step3_subresult1 step3_subresult2 by auto 
 have step3_subresult4: "fst (wall_count (basic ((cement vert)⊗w4))) = snd (wall_count ?x2)" 
               using step3_subresult3 subresult0 wall_count_def step3_subresult2 subresult1 by auto 
 have step3_subresult5: "fst (wall_count (basic ((cement vert)⊗w4))) 
 ...
 have step3_subresult8: "strands (vert#(cement vert))" using  append_blocks_def strands_def  
   brickstrand.simps(1) strands.simps(1) strands.simps(2) 
                       by metis
 have step3_subresult9: "(vert#(cement vert)) = ((cement vert)⊗(cement vert))" using append_blocks_Nil 
                        by metis
 have step3_subresult10: "strands ((cement vert)⊗(cement vert))" 
 ...
 have step3_subresult18: "linkrel_equiv 
  ...
  (Abs_diagram ((x1)∘(basic y1)∘(basic ((cement cup) ⊗ ((cement vert) ⊗ w4)))∘((basic ((cement vert)
  ⊗(cement cap)⊗w4))∘z1)))"
 ...
 have step4_subresult1: "strands ((cement vert) ⊗ (cement vert) ⊗ (cement vert) ⊗ w4)"
     using assms  append_blocks.append_blocks_Nil  preliminary_result3 step2_subresult1 
     strands.simps(2) by metis
 have step4_subresult2: "snd (count ((cement cup)⊗y1)) =  snd (count (cup#y1))" 
 ...
 have step4_subresult4: "snd (count ((cement cup)⊗y1)) > snd (count (y1))"
     using step4_subresult2 step4_subresult3 add_strict_increasing dbl_def 
     dbl_simps(3) order_refl zero_less_two by auto
 have step4_subresult5: "snd (count ((cement cup)⊗y1)) > 1"
     using step4_subresult4 assms by auto
 have step4_subresult6: "snd (wall_count ?p) = (snd (count ((cement cup)⊗y1)))"
...
(*step 2 - inducing is_cup*)
 have w_subst: "w4 = (make_vert_block ?k)" using assms by auto
 have step2_subresult0: "(make_vert_block (?k+1)) = ((make_vert_block ?k) ⊗(cement vert))" 
               by (metis test_00 test_1)
 have step2_subresult1:"?z4 = (make_vert_block ?k)⊗(cement vert)  " using C step2_subresult0 by auto
 have step2_subresult2: "(Abs_diagram (?x2 ∘ (basic ?z4) ∘(basic ?z4)∘z1)) =
 ...
 have step2_subresult4:
  "∃y1.∃y2.∃w1.∃w2.
   (?x = Abs_diagram (y1 ∘ (basic (w1⊗(cement vert)⊗(cement cup))) 
    ∘ (basic (w2⊗(cement cap)⊗(cement vert))) ∘ y2))"
              using exI by auto
 have step2_subresult5:
 "∃y1.∃y2.∃w1.∃w2.(?y = Abs_diagram (y1 ∘ (basic (w1⊗(cement vert))) 
                   ∘ (basic (w2⊗(cement vert))) ∘ y2))"
               using exI by auto
 have step2_subresult6: 
   " (∃y1.∃w1.∃w2.∃y2.((?x = Abs_diagram ((y1)
    ∘ (basic (w1⊗(cement vert)⊗(cement cup))) ∘ (basic (w2⊗(cement cap)⊗(cement vert))) ∘ y2)))
 ...
 have step2_subresult8:"linkrel ?x ?y" 
                using linkrel_def linkrel_straighten_def step2_subresult7 by auto
 have step2_subresult9: "linkrel (Abs_diagram ((?x2) ∘(basic (w4⊗(cement vert)⊗(cement cup)))
                ∘(basic (w4⊗(cement cap)⊗(cement vert)))∘z1)) 
              (Abs_diagram ((?x2) ∘(basic (w4⊗(cement vert)))∘(basic (w4⊗(cement vert)))∘z1))"
               using step2_subresult8 by auto 
 have step2_equiv1:"linkrel_equiv (Abs_diagram (x1∘basic y1∘(basic (w4⊗(cement vert)⊗(cement cup)))
                                   ∘(basic (w4⊗(cement cap)⊗(cement vert)))∘z1)) 
 ...
 (*step 3*)
 have step3_preliminary1: "fst (count (v⊗w)) = fst (count (cup#(v⊗w)))" 
               using count_def brickcount_def by auto
 have step3_preliminary2 : 
       "count ((w4⊗(cement vert))⊗(cement cup)) = 
                 ((fst (count (w4⊗(cement vert)))), (snd (count (w4⊗(cement vert)))+2))"
              using fstcount_cup_rightcompose  count_cup_rightcompose by (metis) 
 have step3_preliminary3 : 
       "fst (count ((w4⊗(cement vert))⊗(cement cup))) = (fst (count (w4⊗(cement vert))))"
              using step3_preliminary2 by auto
 have step3_subresult1 :
    "fst (wall_count (basic ((w4⊗(cement vert))⊗(cement cup)))) 
             ...
             using wall_count_def step3_preliminary3 append_blocks.append_blocks_Nil add_diff_cancel 
              comm_monoid_add_class.add.left_neutral count.simps(2) fst_conv wall_count.simps(1)
             by (metis)
 have step3_subresult2: "fst (wall_count (basic (w4⊗(cement vert)))) = snd (count y1)" 
              using w_subst step2_subresult1 subresult8 by auto
 have step3_subresult3: "fst (wall_count (basic ((w4⊗(cement vert)⊗(cement cup))))) = snd (count y1)" 
               using step3_subresult1 step3_subresult2 leftright_associativity
               by (auto)
 have step3_subresult4: "fst (wall_count (basic (w4⊗(cement vert)))) = snd (wall_count ?x2)" 
               using step3_subresult3 subresult0 wall_count_def step3_subresult2 subresult1 by auto 
 have step3_subresult5: "fst (wall_count (basic (w4⊗(cement vert)))) 
                         = snd (wall_count (x1∘(basic y1)))" 
               using step3_subresult4  wall_count_def by auto
 have step3_subresult6: "fst (brickcount cup) =  0" using brickcount_def by auto
 have step3_subresult7: "fst (count (cement cup)) =  0" using count_def step3_subresult6 
 ...
 have step3_subresult8: "strands (vert#(cement vert))" 
                       ...
                       by metis
 have step3_subresult9: "(vert#(cement vert)) = ((cement vert)⊗(cement vert))" 
 ...
 let ?b = "Abs_diagram ((x1)∘(basic y1)∘(basic ((w4⊗(cement vert)) ⊗ (cement cup)))
            ∘((basic (w4⊗(cement cap)⊗(cement vert)))∘z1))"
 have step3_subresult11: "  ∃y1.∃w1.∃w2.∃A.∃B.∃y2.
 ...
 let ?b = "Abs_diagram ((x1)∘(basic y1)∘(basic ((w4⊗(cement vert)) ⊗ (cement cup)))
                           ∘((basic (w4⊗(cement cap)⊗(cement vert)))∘z1))"
 have step3_subresult13: " ∃y1.∃z1.∃z2.∃A.∃B.∃y2.(
...
(*step 4*)
 ...
 have step4_subresult1: "strands (?z4 ⊗ (cement vert) ⊗ (cement vert))"
    using assms  append_blocks.append_blocks_Nil preliminary_result3 step2_subresult1 
     strands.simps(2) leftright_associativity test_0 by (metis)
 have step4_subresult2: "snd (count (y1⊗(cement cup))) =  snd (count (y1)) + 2"
           apply (induct_tac y1)
           apply (auto)
           done
 have step4_subresult4: "snd (count (y1 ⊗ (cement cup))) > snd (count (y1))"
          using step4_subresult2 add_strict_increasing dbl_def dbl_simps(3) order_refl zero_less_two
          by auto
 have step4_subresult5: "snd (count (y1 ⊗ (cement cup))) > 1"
          using step4_subresult4 assms by auto
 have step4_subresult6: "snd (wall_count ?p) = (snd (count (y1⊗(cement cup))))"
          using wall_count_def  snd_conv wall_count.simps(1) wall_count_compose by auto
 have step4_subresult7: "snd (wall_count ?p) > 0"
          using step4_subresult5 step4_subresult6 assms by auto
 have step4_subresult8: 
...
proof-
 ...
 have preliminary_result3:"((fst (count y1))+(-1))>0" 
   using assms by auto
 have preliminary_result4:"((fst (count y1))+(-2))≥0" 
   using assms by auto
...
(*step 2*)
 ...
 have step2_subresult0: "(make_vert_block (?k+1)) = ((make_vert_block ?k) ⊗(cement vert))" 
        by (metis test_00 test_1)
 have step2_subresult1:"?z4 = (make_vert_block ?k)⊗(cement vert)  " 
 ...
 have step2_subresult4:
  "∃a.∃b.∃c.∃d.
    (?x = Abs_diagram (a ∘ (basic (b⊗(cement cup)⊗(cement vert) )) 
                      ∘ (basic (c⊗(cement vert)⊗(cement cap))) ∘ d))"
          using exI by auto
 have step2_subresult5:
 "∃a.∃b.∃c.∃d.(?y = Abs_diagram (a ∘ (basic (b⊗(cement vert))) ∘ (basic (c⊗(cement vert))) ∘ d))"
          using exI by auto
 have step2_subresult6: 
 "(∃a.∃b.∃c.∃d.
  ((?x = Abs_diagram ((a) ∘ (basic (b⊗(cement cup)⊗(cement vert))) 
                      ∘(basic (c⊗(cement vert)⊗(cement cap))) ∘ d)))
  ∧(?y = Abs_diagram (a ∘ (basic (b⊗(cement vert))) ∘ (basic (c⊗(cement vert))) ∘ d))
...
(*step 3*)
 ...
 have step3_subresult4: "(vert#(cement vert)) = ((cement vert)⊗(cement vert))"
             using append_blocks_Nil  by metis
 have step3_subresult5: "strands ((cement vert)⊗(cement vert))" 
 ...
 have step3_subresult6: " ∃a1.∃b1.∃b2.∃A.∃B.∃a2.
                 (?a = Abs_diagram ((a1)∘(basic (b1⊗A))∘(basic (b2⊗B))∘(a2)))"
          using exI by metis
 have step3_subresult7: " ∃a1.∃b1.∃b2.∃a2.∃B.
                  (?b  = (Abs_diagram ((a1)∘(basic (b1⊗B))∘(basic (b2))∘(a2))))"
          using exI by metis
 have step3_subresult8: " ∃a1.∃b1.∃b2.∃A.∃B.∃a2.
       (?a = Abs_diagram ((a1)∘(basic (b1⊗A))∘(basic (b2⊗B))∘(a2))
     ∧(?b  = (Abs_diagram ((a1)∘(basic (b1⊗B))∘(basic (b2))∘(a2))))
...
(*step 4*)
 ...
 have step4_subresult1: "strands (?z4 ⊗ (cement vert) ⊗ (cement vert))"
         ...
         by (metis)
 have step4_subresult2: "fst (count (y1⊗(cement cap))) =  fst (count (y1)) + 2"
         apply (induct_tac y1)
         apply (auto)
         done
 have step4_subresult4: "fst (count (y1 ⊗ (cement cap))) = fst (count (y1))+2"
          using step4_subresult2 add_strict_increasing dbl_def dbl_simps(3) order_refl zero_less_two
          by auto
 have step4_subresult5: "fst (count (y1 ⊗ (cement cap))) > 1"
          using step4_subresult4 assms by auto
 have step4_subresult6: "snd (wall_count ?p) = snd (count (w4⊗(cement cup)⊗(cement vert)))"
          using wall_count_def  snd_conv wall_count.simps(1) wall_count_compose by auto
 have step4_subresult7: "snd (count (x⊗(cement vert))) >0 "
          ...
          by (metis)
 have step4_subresult8: "snd (count ((w4⊗(cement cup))⊗(cement vert))) > 0"
 ...
 "linkrel
  (Abs_diagram ((x1)∘(basic (w4⊗(cement cup)⊗(cement vert)))∘(basic (?z4 ⊗ (cement vert) ⊗ (cement vert)))∘(basic (y1 ⊗ (cement cap)))∘z1))
  (Abs_diagram ((x1)∘(basic (w4⊗(cement cup)⊗(cement vert)))∘(basic (y1 ⊗ (cement cap)))∘z1))"
...
assumes "(fst (count y1))>1"
and "w4 = make_vert_block  (nat ((fst (count y1)) + (-2)))" and "well_defined (x1 ∘ basic y1 ∘z1)"
shows "linkrel_equiv (Abs_diagram ((x1)∘(basic ((cement vert)⊗(cement cup)⊗w4)∘(basic ((cement cap)⊗y1))∘z1)))    
 (Abs_diagram (x1 ∘ (basic y1) ∘z1))" 
proof-
let ?z4 ="make_vert_block (nat ((fst (wall_count (basic y1))) + (-2))+1)"
let ?k = " (nat ((fst (count y1))+ (-2) ))" 
...
have preliminary_result5: "strands ?z4" using C strand_make_vert_block by auto
...
have step2_subresult3: "(snd (count w4)) = (fst (count w4))" using make_vert_block_fstsndequality w_subst
by auto
let ?z3 = " (basic y1)∘ z1"
let ?x = "(Abs_diagram (x1 ∘(basic ((cement vert)⊗(cement cup)⊗w4))∘(basic ((cement cap)⊗(cement vert)⊗w4))∘(?z3)))"
let ?y = "(Abs_diagram (x1 ∘(basic ((cement vert)⊗w4))∘(basic ((cement vert)⊗w4))∘ (?z3)))"

have step2_subresult4:
"∃a.∃b.∃c.∃d.(?x = Abs_diagram (a ∘ (basic ((cement vert)⊗(cement cup)⊗b )) ∘ (basic ((cement cap)⊗(cement vert)⊗c)) ∘ d))"
  using exI by auto
...
∘ (basic ((cement vert)⊗(cement cup)⊗b)) ∘ (basic ((cement cap)⊗(cement vert)⊗c)) ∘ d)))
...
using linkrel_straighten_righttopdown_def 
...
have step2_subresult9: "linkrel 
              (Abs_diagram ((x1) ∘(basic ((cement vert)⊗(cement cup)⊗w4))∘(basic ((cement cap)⊗(cement vert)⊗ w4))∘(?z3))) 
              (Abs_diagram ((x1) ∘(basic ((cement vert)⊗w4))∘(basic ((cement vert) ⊗w4))∘(?z3)))"
               using step2_subresult8 by auto

have step2_subresult10: "linkrel_equiv 
              (Abs_diagram ((x1) ∘(basic ((cement vert)⊗(cement cup)⊗w4))∘(basic ((cement cap)⊗(cement vert)⊗w4))∘((basic y1)∘ z1))) 
              (Abs_diagram ((x1) ∘(basic ((cement vert)⊗w4))∘(basic ((cement vert)⊗w4))∘((basic y1)∘ z1)))"
               using step2_subresult9 compose_leftassociativity r_into_rtranclp 
               linkrel_equiv_def
                     by metis
...
have step2: "linkrel_equiv 
       (Abs_diagram ((x1) ∘(basic ((cement vert)⊗(cement cup)⊗w4))∘(basic ((cement cap)⊗?z4))∘((basic y1)∘ z1)))      
         (Abs_diagram ((x1) ∘(basic (?z4))∘(basic (?z4))∘((basic y1)∘ z1)))"
               using step2_subresult11 step2_subresult1 
                   Link.abs_eq_iff compose_Nil leftright_associativity 
                   step1 step2_subresult4 step2_subresult6 subresult8 w_subst
...
have step3_subresult3: "strands (vert#(cement vert))" using  append_blocks_def strands_def  brickstrand.simps(1) 
                        strands.simps(1) strands.simps(2) 
                       by metis
have step3_subresult4: "(vert#(cement vert)) = ((cement vert)⊗(cement vert))" using append_blocks_Nil
                        by metis
have step3_subresult5: "strands ((cement vert)⊗(cement vert))" using step3_subresult3 step3_subresult4
                        by metis

let  ?a = 
"Abs_diagram (((x1) ∘(basic ((cement vert)⊗(cement cup)⊗w4)))∘(basic ((cement vert)⊗(cement vert)⊗?z4))∘(basic ((cement cap)⊗y1))∘ z1) "
let ?b = " (Abs_diagram (((x1) ∘(basic ((cement vert)⊗(cement cup)⊗w4)))∘(basic ((cement cap)⊗?z4))∘(basic y1)∘ z1)) "
...
have step3_subresult9: "linkrel_compabove_centerright ?a ?b" using step3_subresult8
linkrel_compabove_centerright_def 
 step2_subresult3 step3_subresult6 step3_subresult7  zero_reorient
 by metis

have step3_subresult10: "linkrel_compabove ?a ?b" using step3_subresult9 
linkrel_compabove_def by auto

have step3_subresult11: "linkrel_compress ?a ?b" using step3_subresult10 
linkrel_compress_def by auto
have step3_subresult12: "linkrel ?a ?b" using step3_subresult11 linkrel_def by auto
...
(*"linkrel_equiv (Abs_diagram ((x1)∘(basic ((cement vert)⊗(cement cup)⊗w4)∘(basic ((cement vert)⊗(cement vert)⊗?z4))∘
(basic ((cement cap)⊗y1))∘z1)))     (Abs_diagram (x1 ∘ (basic y1) ∘z1))*)
...
have step4_subresult1: "strands ((cement vert) ⊗ (cement vert)⊗?z4)"
using assms  append_blocks.append_blocks_Nil preliminary_result3 step2_subresult1 strands.simps(2)
leftright_associativity test_0 strand_make_vert_block wall_count.simps(1)
by (metis )

have step4_subresult2: "fst (count ((cement cap)⊗y1)) =  (fst (count (cement cap))) + fst (count (y1)) "
...
have step4_subresult4: "fst (count ((cement cap)⊗y1)) = fst (count (y1))+2"
using step4_subresult2 step4_subresult3 add_strict_increasing dbl_def 
dbl_simps(3) order_refl zero_less_two
by auto

have step4_subresult5: "fst (count ((cement cap)⊗y1)) > 1"
using step4_subresult4 assms
by auto

have step4_subresult6: "snd (wall_count ?p) = snd (count ((cement vert)⊗(cement cup)⊗w4))"
using wall_count_def  snd_conv wall_count.simps(1) wall_count_compose
by auto

have step4_subresult7: "snd (count ((cement vert)⊗x)) >0 "
using snd_count_positive  brickcount_def count_def 
make_vert_block.simps(1) make_vert_block_fstsndequality make_vert_blocks_positiveblock_length
by (metis add_nonneg_eq_0_iff antisym_conv1 snd_count_additive snd_count_nonnegative)


have step4_subresult8: "snd (count ((cement vert)⊗((cement cap)⊗w4))) > 0"
...
by (metis One_nat_def add_0_iff le_neq_trans make_vert_block.simps(1) make_vert_block_sndequality 
...
(Abs_diagram (?p∘?r∘?q))
 (Abs_diagram (?p∘?q))"
using step4_subresult1 step4_subresult7 linkrel_compress_null_def leftright_associativity step4_subresult6 step4_subresult8 
step4_subresult9
by (metis)
...
"linkrel_compress
 (Abs_diagram (?p∘?r∘?q))
(Abs_diagram (?p∘?q))"
using step4_subresult10 linkrel_compress_def
by auto
...
"linkrel
 (Abs_diagram (?p∘?q))
(Abs_diagram (?p∘?r∘?q))"
using step4_subresult11 step4_subresult10 linkrel_def
by auto
...
using step4_subresult12  compose_leftassociativity linkrel_def
by metis
...
have combine_vert: 
"linkrel_equiv  (Abs_diagram (((x1) ∘(basic ((cement vert)⊗(cement cup)⊗w4)))∘(basic ((cement cap) ⊗?z4))∘(basic y1)∘ z1))
                  (Abs_diagram (x1 ∘ basic y1 ∘z1))" 
...
(Abs_diagram ((x1)∘(basic ((cement vert)⊗(cement cup)⊗w4))∘(basic ((cement cap) ⊗ y1))∘z1))
  (Abs_diagram (x1 ∘ basic y1 ∘z1))"
using combine_cup step4 rtranclp_trans  combine_cup step4  rtranclp_trans  linkrel_equiv_def 
                compose_leftassociativity leftright_associativity 
               step2 step2_subresult1 step2_subresult2  subresult_equiv3 
               w_subst
by metis 
...
assumes "(snd (count y2))>1" and "(z4 = make_vert_block (nat ((snd (count y2)) + (-2))+1))"
and "w4 = make_vert_block  (nat ((snd (count y2)) + (-2)))" and "fst (count y2) = snd (count y1)"
shows "linkrel_equiv 
...
by (metis)
have subresult3: " strands ((cement vert)⊗(cement vert))" using  append_blocks_Nil strands_def 
...
∘(basic ((cement vert)⊗(cement cap)⊗w4))∘z1))"
let ?b = "(Abs_diagram ((x1 ∘ (basic y1)) ∘(basic ((cement cup)⊗y2))∘(basic ((cement vert)⊗(cement cap)⊗w4))∘z1))"
...
from this have "linkrel_compbelow_centerright ?a ?b" using linkrel_compbelow_centerright_def
by auto
from this have "linkrel_compbelow ?a ?b" using linkrel_compbelow_def by auto
from this have "linkrel_compress ?a ?b" using linkrel_compress_def by auto
then have " linkrel ?a ?b" using linkrel_def by auto
then have "linkrel_equiv ?a ?b" using linkrel_equiv_def  r_into_rtranclp by (metis)
then have subresult5: "linkrel_equiv  
(Abs_diagram ((x1)∘(basic ((cement cup)⊗y1))∘(basic ((cement vert)⊗(cement vert)⊗y2))∘(basic ((cement vert)⊗(cement cap)⊗w4))∘z1))
(Abs_diagram ((x1 ∘ (basic y1)) ∘(basic ((cement cup)⊗y2))∘(basic ((cement vert)⊗(cement cap)⊗w4))∘z1))"
by auto
...
and "w4 = make_vert_block  (nat ((snd (count y2)) + (-2)))" and "fst (count y2) = snd (count y1)"
shows "linkrel_equiv (Abs_diagram ((x1)∘(basic ((cement cup)⊗y1))∘(basic ((cement vert)⊗(cement vert)⊗y2))
            ∘(basic ((cement vert)⊗(cement cap)⊗w4))∘z1))
             (Abs_diagram (x1 ∘ basic y1∘ basic y2∘z1))" 
proof-
let ?x = "x1 ∘ (basic y1)"
have subresult1: "linkrel_equiv 
   (Abs_diagram ((x1 ∘ (basic y1)) ∘(basic ((cement cup)⊗y2))∘(basic ((cement vert)⊗(cement cap)⊗w4))∘z1))
           (Abs_diagram ((x1 ∘ (basic y1)) ∘ basic y2 ∘z1))"  using assms metaequivalence_left 
             by auto
have subresult2: "linkrel_equiv 
 (Abs_diagram ((x1)∘(basic ((cement cup)⊗y1))∘(basic ((cement vert)⊗(cement vert)⊗y2))∘(basic ((cement vert)⊗(cement cap)⊗w4))∘z1))
(Abs_diagram (x1 ∘ (basic y1) ∘(basic ((cement cup)⊗y2))∘(basic ((cement vert)⊗(cement cap)⊗w4))∘z1))"
...
then have "linkrel_equiv 
 (Abs_diagram ((x1)∘(basic ((cement cup)⊗y1))∘(basic ((cement vert)⊗(cement vert)⊗y2))∘(basic ((cement vert)⊗(cement cap)⊗w4))∘z1))
           ...
           Link.abs_eq_iff compose_leftassociativity assms
           by metis
...
assumes "(snd (count y2))>1" 
and "w4 = make_vert_block  (nat ((snd (count y2)) + (-2)))" and "fst (count y2) = snd (count y1)"
shows "linkrel_equiv (Abs_diagram ((x1)∘(basic (y1⊗(cement cup)))∘(basic (y2⊗(cement vert)⊗(cement vert)))∘(basic (w4⊗(cement cap)⊗(cement vert)))∘z1))
             (Abs_diagram (x1 ∘ (basic y1) ∘(basic (y2⊗(cement cup)))∘(basic (w4⊗(cement cap)⊗(cement vert)))∘z1))"
proof-
have "fst (brickcount cup) = 0" using brickcount_def by auto
from this have subresult2:"fst (count ((cement cup))) = 0" using count_def  count.simps(1) 
by (metis)
...
let ?a = " (Abs_diagram ((x1)∘(basic (y1⊗(cement cup)))∘(basic (y2⊗(cement vert)⊗(cement vert)))∘(basic (w4⊗(cement cap)⊗(cement vert)))∘z1))"

let ?b = "(Abs_diagram (x1 ∘ (basic y1) ∘(basic (y2⊗(cement cup)))∘(basic (w4⊗(cement cap)⊗(cement vert)))∘z1))"
...
from this have "linkrel_compbelow_centerleft ?a ?b" using linkrel_compbelow_centerleft_def
by auto
...
then have " linkrel ?a ?b" using linkrel_def by auto
then have "linkrel_equiv ?a ?b" using linkrel_equiv_def  r_into_rtranclp by (metis)
then have "linkrel_equiv (Abs_diagram ((x1)∘(basic (y1⊗(cement cup)))∘(basic (y2⊗(cement vert)⊗(cement vert)))∘(basic (w4⊗(cement cap)⊗(cement vert)))∘z1))
             (Abs_diagram (x1 ∘ (basic y1) ∘(basic (y2⊗(cement cup)))∘(basic (w4⊗(cement cap)⊗(cement vert)))∘z1))"
by auto
from this show ?thesis by auto
qed
...
assumes "(snd (count y2))>1" 
and "w4 = make_vert_block  (nat ((snd (count y2)) + (-2)))" and "fst (count y2) = snd (count y1)"
shows "linkrel_equiv (Abs_diagram ((x1)∘(basic (y1⊗(cement cup)))∘(basic (y2⊗(cement vert)⊗(cement vert)))∘
(basic (w4⊗(cement cap)⊗(cement vert)))∘z1))
             (Abs_diagram (x1 ∘ (basic y1)∘ (basic y2)∘z1))" 
proof-
let ?x = "x1 ∘ (basic y1)"
...
from this have  " linkrel_equiv (Abs_diagram (((x1)∘(basic (y1⊗(cement cup))))∘(basic (y2⊗(cement vert)⊗(cement vert)))∘(basic (w4⊗(cement cap)⊗(cement vert)))∘z1))
              (Abs_diagram ((x1 ∘ (basic y1)) ∘ basic y2 ∘z1))" 
...
proof-
have subresult1: "linkrel_equiv (Abs_diagram ((x1)∘(basic (y1⊗(cement cup)))∘(basic (y2⊗(cement vert)⊗(cement vert)))∘
(basic (w4⊗(cement cap)⊗(cement vert)))∘z1))
...
from this have subresult2:  "(snd (count (y2⊗(cement vert)⊗(cement vert)))) = (snd (count (y2)) + 2)"
using  append_blocks_Nil  append_blocks_Cons brickcount_def count_def
by (metis (hide_lams, no_types) brickcount.simps(1) count.simps(1) count_rightcompose
dbl_def dbl_simps(3) snd_conv)
from this have "snd (count (y2 ⊗ (cement vert) ⊗ (cement vert))) > (snd (count y2))" by auto
...
from this have assm2_substep1: "(fst (count (y2⊗(cement vert)⊗(cement vert)))) = (fst (count (y2)) + 2)"
using  append_blocks_Nil append_blocks_Cons brickcount_def count_def
by (metis (hide_lams, no_types) brickcount.simps(1) count.simps(1) count_rightcompose
...
from this have "(snd (count (y1⊗(cement cup)))) = ((fst (count y2)) +2)" using assms by auto
...
from this have subresult5: "w5 = make_vert_block (nat (((snd (count ?p2)) + (-2))))" using assms by auto
have subresult3: "(((snd (count ?p2))>1) ∧ (w5= make_vert_block  (nat ((snd (count ?p2)) + (-2))))
∧(fst (count ?p2) = snd (count ?p1)))"
using assms step1 step2 subresult5 by auto
from this have "linkrel_equiv (Abs_diagram ((x1)∘(basic ((cement cup)⊗?p1))∘(basic ((cement vert)⊗(cement vert)⊗?p2))
...
from this have subresult6: "linkrel_equiv (Abs_diagram ((x1)∘(basic ((cement cup)⊗y1 ⊗ (cement cup)))
  ∘(basic ((cement vert)⊗(cement vert)⊗y2 ⊗ (cement vert) ⊗(cement vert)))
...
and "fst (count y2) = snd (count y1)"
shows "linkrel_equiv (Abs_diagram ((x1)∘(basic ((cement cup)⊗y1⊗(cement cup)))∘
(basic ((cement vert)⊗(cement cap)⊗ w5)) ∘ (basic (w4⊗(cement cap)⊗(cement vert)))∘z1))
             (Abs_diagram (x1 ∘ (basic y1)∘ z1))" 
proof-
from metaequivalence_right and assms have subresult1: "linkrel_equiv 
      (Abs_diagram ((x1)∘(basic (y1⊗(cement cup)))∘(basic (w4⊗(cement cap)⊗(cement vert)))∘z1))
...
from subresult2 have subresult4: "w5 = make_vert_block (nat (snd (count ?y2) + (-2)))" using assms by auto
from this and assms and subresult3 and metaequivalence_left have "linkrel_equiv 
      (Abs_diagram ((x1)∘(basic ((cement cup)⊗?y2))∘(basic ((cement vert)⊗(cement cap)⊗ w5))∘?z2))
               (Abs_diagram ((x1)∘(basic (?y2))∘?z2))" by auto
from this have "linkrel_equiv 
      (Abs_diagram ((x1)∘(basic ((cement cup)⊗y1⊗(cement cup)))∘(basic ((cement vert)⊗(cement cap)⊗ w5))∘(basic (w4⊗(cement cap)⊗(cement vert)))∘z1))
               (Abs_diagram ((x1)∘(basic (y1 ⊗ (cement cup)))∘(basic (w4⊗(cement cap)⊗(cement vert)))∘z1))" by auto
from this and subresult1 have "linkrel_equiv 
      (Abs_diagram ((x1)∘(basic ((cement cup)⊗y1⊗(cement cup)))∘(basic ((cement vert)⊗(cement cap)⊗ w5))∘(basic (w4⊗(cement cap)⊗(cement vert)))∘z1))
...
and "well_defined (x1 ∘ basic y1 ∘ z1)" 
shows "linkrel_equiv (Abs_diagram ((x1)∘  (basic (w4⊗(cement cup)⊗(cement vert))) ∘
(basic ((cement vert)⊗(cement cup)⊗w5))∘(basic ((cement cap)⊗y1⊗(cement cap)))∘z1))
             (Abs_diagram (x1 ∘ (basic y1)∘ z1))" 
proof-
have "(fst (count y1))>1" using assms by auto
also have  "w4 = make_vert_block  (nat ((fst (count y1)) + (-2)))" using assms by auto
 have "well_defined (x1 ∘ basic y1 ∘ z1)"  using assms by auto
from assms and metaequivalence_bottomright have subresult1: "linkrel_equiv 
      (Abs_diagram ((x1)∘(basic (w4⊗(cement cup)⊗(cement vert)))∘(basic (y1⊗(cement cap)))∘z1))
             (Abs_diagram (x1 ∘ (basic y1)∘z1))"  
by auto
...
using count_def fst_conv append_blocks_Cons count_cup_rightcompose by (metis brickcount.simps(3) count.simps(1)
 fst_count_additive)
from this and assms have subresult3:"(fst (count (?y2))) >1" by auto
have subresult4: " snd (count (y1⊗(cement cap))) = snd (count y1)" using 
 count_def snd_conv append_blocks_Cons count_cup_rightcompose
...
from this have subresult5: "snd (count (w4⊗(cement cup)⊗(cement vert))) = snd (count w4) +3"
...
have "fst (count (w4⊗(cement cup)⊗(cement vert))) =  fst (count w4) + fst (count (cement cup)) + fst( count (cement vert))"
using leftright_associativity fst_count_additive by auto
from this have subresult6: "fst (count (w4⊗(cement cup)⊗(cement vert))) =  fst (count w4) + 1"
using count_def  fst_conv brickcount.simps(1) count.simps(1) fst_count_additive 
fstcount_cup_rightcompose
 by (metis (full_types))
have "(snd (count (make_vert_block n))) = (int n)+1"  using make_vert_block_sndequality by auto
have subresult7: "(fst (count w4)) = (int (nat ((fst (count y1)) + (-2))))+1" using assms make_vert_block_fstequality
by (metis)
...
from this and make_vert_block_fstsndequality and assms have " snd (count w4) =  fst (count y1) + (-1)"
by auto
from this and subresult5 have "snd (count (w4⊗(cement cup)⊗(cement vert))) = fst (count y1) + (-1) + 3" by auto
from this and subresult2 have subresult9: "snd (count (w4⊗(cement cup)⊗(cement vert))) = fst (count (y1⊗(cement cap)))" by auto
from subresult8 and subresult6 have subresult10: "fst (count (w4⊗(cement cup)⊗(cement vert))) = fst (count y1)" by auto
from subresult2 have subresult11: "w5 = make_vert_block (nat (fst (count ?y2) + (-2)))" using assms by auto
...
from this and subresult10 have subresult13: "snd(wall_count x1) = (fst (count (w4⊗(cement cup)⊗(cement vert))))" by auto
...
have "(fst (wall_count ((basic (w4⊗(cement cup)⊗(cement vert)))∘(basic ?y2)∘z1))) = fst (count (w4⊗(cement cup)⊗(cement vert)))"
by auto
from this and  subresult13 have subresult17: "snd(wall_count x1) = (fst (wall_count ((basic (w4⊗(cement cup)⊗(cement vert)))∘(basic ?y2)∘z1)))"
by auto

have  "list_sum (wall_count_list (?y2*z1)) = 0" using subresult16 
by (metis add_nonneg_eq_0_iff assms(4) 
compose_Nil diagram_list_sum_zero diagram_wall_count_list_zero list_sum.simps(2) 
list_sum_append_blocks monoid_add_class.add.left_neutral subresult15 wall_count_list.simps(2) 
wall_count_list_compose wall_count_list_list_sum_non_negative)
from this have subresult18: " list_sum (wall_count_list ((basic ?y2)∘z1)) = 0" by auto
from subresult9 have "snd (count (w4⊗(cement cup)⊗(cement vert))) = (fst (wall_count (((basic ?y2)∘z1))))"
...
from this have subresult19: "list_sum (wall_count_list ((basic (w4⊗(cement cup)⊗(cement vert)))∘((basic ?y2)∘z1))) = 0"
by auto

from diagram_list_sum_subsequence have subresult20: " ((list_sum (wall_count_list x1) = 0)
∧((list_sum (wall_count_list ((basic y1)∘z1)))=0))" using assms by metis
have "list_sum (wall_count_list ((x1)∘(basic (w4⊗(cement cup)⊗(cement vert)))∘(basic (y1⊗(cement cap)))∘z1)) = 
list_sum (wall_count_list ((x1))) + list_sum (wall_count_list ((basic (w4⊗(cement cup)⊗(cement vert)))∘(basic (y1⊗(cement cap)))∘z1))
+ abs ((fst (wall_count ((basic (w4⊗(cement cup)⊗(cement vert)))∘(basic (y1⊗(cement cap)))∘z1))) - (snd (wall_count x1)))"
using wall_count_list_list_sum_compose by auto
from this and subresult19 and subresult20 and subresult17 
have subresult21: "list_sum (wall_count_list ((x1)∘(basic (w4⊗(cement cup)⊗(cement vert)))∘(basic (y1⊗(cement cap)))∘z1)) =0"
...
have subresult26:" (fst (wall_count (((x1)∘(basic (w4⊗(cement cup)⊗(cement vert)))∘(basic (y1⊗(cement cap)))∘z1))))
= fst(wall_count x1)" 
using wall_count_def compose_Cons by (metis fst_conv wall_count_compose)
from this and subresult23 
have subresult27:" abs (fst (wall_count (((x1)∘(basic (w4⊗(cement cup)⊗(cement vert)))∘(basic (y1⊗(cement cap)))∘z1)))) = 0" by auto
have subresult28:" (snd (wall_count (((x1)∘(basic (w4⊗(cement cup)⊗(cement vert)))∘(basic (y1⊗(cement cap)))∘z1))))
= snd (wall_count z1)" 
...
" abs (snd (wall_count (((x1)∘(basic (w4⊗(cement cup)⊗(cement vert)))∘(basic (y1⊗(cement cap)))∘z1))))= 0" by auto
from subresult27 and subresult29 and subresult21 have subresult30: "well_defined  
(((x1)∘(basic (w4⊗(cement cup)⊗(cement vert)))∘(basic (y1⊗(cement cap)))∘z1))" 
...
by (metis)
from this have "linkrel_equiv
 (Abs_diagram ((x1)∘(basic (w4⊗(cement cup)⊗(cement vert)))∘(basic ((cement vert)⊗(cement cup)⊗ w5))∘(basic ((cement cap)⊗y1⊗(cement cap)))∘z1))  
       (Abs_diagram ((x1)∘(basic (w4⊗(cement cup)⊗(cement vert)))∘(basic (y1⊗(cement cap)))∘z1))" 
...
shows "linkrel_equiv (Abs_diagram ((x1)∘  (basic ((cement vert)⊗(cement cup)⊗w4)) ∘
(basic ((cement cap)⊗y1))∘(basic (y2⊗(cement cup)))∘(basic (w5⊗(cement cap)⊗(cement vert)))∘z1))
             (Abs_diagram (x1 ∘ (basic y1)∘ (basic y2)∘z1))" 
proof-
have subresult: "linkrel_equiv (Abs_diagram ((x1)∘  (basic ((cement vert)⊗(cement cup)⊗w4)) ∘
...
have "linkrel_equiv (Abs_diagram (?x2∘(basic (y2⊗(cement cup)))∘(basic (w5⊗(cement cap)⊗(cement vert)))∘z1))
           (Abs_diagram (?x2∘(basic y2)∘z1))" using assms metaequivalence_right by (metis (full_types))
from this have "linkrel_equiv (Abs_diagram ((x1)∘(basic ((cement vert)⊗(cement cup)⊗w4)) ∘(basic ((cement cap)⊗y1))
∘(basic (y2⊗(cement cup)))∘(basic (w5⊗(cement cap)⊗(cement vert)))∘z1))
           (Abs_diagram ((x1)∘(basic ((cement vert)⊗(cement cup)⊗w4)) ∘(basic ((cement cap)⊗y1))∘(basic y2)∘z1))"
using compose_leftassociativity by (auto)
from this and subresult have " linkrel_equiv  (Abs_diagram ((x1)∘(basic ((cement vert)⊗(cement cup)⊗w4)) ∘(basic ((cement cap)⊗y1))
∘(basic (y2⊗(cement cup)))∘(basic (w5⊗(cement cap)⊗(cement vert)))∘z1))
             (Abs_diagram (x1 ∘ (basic y1)∘ (basic y2)∘z1))"
...
and "well_defined (x1 ∘ basic y1 ∘ basic y2 ∘z1)" 
shows "linkrel_equiv (Abs_diagram ((x1)∘  (basic (w4⊗(cement cup)⊗(cement vert))) ∘
(basic (y1 ⊗(cement cap)))∘(basic ((cement cup)⊗y2))∘(basic ((cement vert)⊗(cement cap)⊗w5))∘z1))
             (Abs_diagram (x1 ∘ (basic y1)∘ (basic y2)∘z1))" 
proof-
have subresult: "linkrel_equiv (Abs_diagram ((x1)∘  (basic (w4⊗(cement cup)⊗(cement vert))) ∘
(basic (y1⊗(cement cap)))∘(basic y2)∘z1))
...
have "linkrel_equiv (Abs_diagram (?x2∘(basic ((cement cup)⊗y2))∘(basic ((cement vert)⊗(cement cap)⊗w5))∘z1))
           (Abs_diagram (?x2∘(basic y2)∘z1))" using assms metaequivalence_left by (metis (full_types))
from this have  "linkrel_equiv (Abs_diagram ((x1)∘(basic (w4⊗(cement cup)⊗(cement vert))) ∘(basic (y1 ⊗(cement cap)))
∘(basic ((cement cup)⊗y2))∘(basic ((cement vert)⊗(cement cap)⊗w5))∘z1))
           (Abs_diagram ((x1)∘(basic (w4⊗(cement cup)⊗(cement vert))) ∘(basic (y1 ⊗(cement cap)))∘(basic y2)∘z1))"
using compose_leftassociativity by auto
from subresult and this have " linkrel_equiv (Abs_diagram ((x1)∘(basic (w4⊗(cement cup)⊗(cement vert))) ∘(basic (y1 ⊗(cement cap)))
∘(basic ((cement cup)⊗y2))∘(basic ((cement vert)⊗(cement cap)⊗w5))∘z1))
           (Abs_diagram ((x1)∘(basic y1)∘(basic y2)∘z1))"
...
shows "linkrel_equiv (Abs_diagram ((x1)∘(basic ((cement cup)⊗y1⊗(cement cup)))∘(basic ((cement vert)⊗(cement vert)⊗y2⊗(cement vert)⊗(cement vert)))∘
(basic ((cement vert)⊗(cement vert)⊗y3⊗(cement vert)⊗(cement vert)))∘(basic ((cement vert)⊗(cement cap)⊗ w5)) ∘ (basic (w4⊗(cement cap)⊗(cement vert)))∘z1))
             (Abs_diagram (x1 ∘ (basic y1)∘(basic y2)∘(basic y3)∘z1))" 
proof-
let ?x2 = "x1∘ (basic y1)"
have  "linkrel_equiv (Abs_diagram (?x2∘(basic ((cement cup)⊗y2⊗(cement cup)))∘
(basic ((cement vert)⊗(cement vert)⊗y3⊗(cement vert)⊗(cement vert)))∘(basic ((cement vert)⊗(cement cap)⊗ w5)) ∘ (basic (w4⊗(cement cap)⊗(cement vert)))∘z1))
             (Abs_diagram (?x2∘(basic y2)∘(basic y3)∘z1))" 
using metaequivalence_both_doubledrop assms by auto
from this have subresult1:
"linkrel_equiv (Abs_diagram (x1∘ (basic y1)∘(basic ((cement cup)⊗y2⊗(cement cup)))∘
(basic ((cement vert)⊗(cement vert)⊗y3⊗(cement vert)⊗(cement vert)))∘(basic ((cement vert)⊗(cement cap)⊗ w5)) ∘ (basic (w4⊗(cement cap)⊗(cement vert)))∘z1))
...
by (auto)
let ?z2 = "(basic ((cement vert)⊗(cement vert)⊗y3⊗(cement vert)⊗(cement vert)))∘(basic ((cement vert)⊗(cement cap)⊗ w5)) 
∘ (basic (w4⊗(cement cap)⊗(cement vert)))∘z1"
...
using append_blocks.append_blocks_Nil  make_vert_block.simps(1) strand_make_vert_block strands.simps(2)
 by (metis)
...
"linkrel_compbelow_centerright 
 (Abs_diagram ((x1)∘(basic ((cement cup)⊗y1))∘(basic ((cement vert)⊗(cement vert)⊗y2⊗(cement cup)))∘
(basic ((cement vert)⊗(cement vert)⊗y3⊗(cement vert)⊗(cement vert)))∘(basic ((cement vert)⊗(cement cap)⊗ w5)) ∘ (basic (w4⊗(cement cap)⊗(cement vert)))
∘z1))
...
have "snd (count ((cement cup) ⊗ y1)) = 2 + snd (count y1)" using snd_count_additive 
comm_semiring_1_class.normalizing_semiring_rules(24) count_cup_rightcompose snd_conv 
snd_count_additive by metis
from this and assms have subresult6: "snd (count ((cement cup) ⊗ y1)) = 2 + fst (count y2)" by auto
...
"(strands ?B) ∧ (fst (count ?subs2) = snd (count ?subs1)) ∧ (fst (count (cement cup)) = 0)" by auto

from this  exI and linkrel_compbelow_centerleft_def  
have "linkrel_compbelow_centerleft
 (Abs_diagram ((x1)∘(basic (?subs1 ⊗ (cement cup)))∘(basic (?subs2⊗?B))∘
?z2))
 (Abs_diagram ((x1)∘(basic (?subs1))∘(basic (?subs2⊗(cement cup)))∘
?z2))" by metis
from this and leftright_associativity have
"linkrel_compbelow_centerleft
 (Abs_diagram ((x1)∘(basic ((cement cup)⊗y1 ⊗ (cement cup)))∘(basic ((cement vert)⊗(cement vert) ⊗ y2 ⊗ (cement vert) ⊗ (cement vert)))∘
(basic ((cement vert)⊗(cement vert)⊗y3⊗(cement vert)⊗(cement vert)))∘(basic ((cement vert)⊗(cement cap)⊗ w5)) 
∘ (basic (w4⊗(cement cap)⊗(cement vert)))∘z1))
 (Abs_diagram ((x1)∘(basic ((cement cup)⊗y1))∘(basic ((cement vert)⊗(cement vert)⊗y2⊗(cement cup)))∘
(basic ((cement vert)⊗(cement vert)⊗y3⊗(cement vert)⊗(cement vert)))∘(basic ((cement vert)⊗(cement cap)⊗ w5)) 
∘ (basic (w4⊗(cement cap)⊗(cement vert)))∘z1))"
...
∘ (basic (w4⊗(cement cap)⊗(cement vert)))∘z1))
 (Abs_diagram ((x1)∘(basic ((cement cup)⊗y1))∘(basic ((cement vert)⊗(cement vert)⊗y2⊗(cement cup)))∘
(basic ((cement vert)⊗(cement vert)⊗y3⊗(cement vert)⊗(cement vert)))∘(basic ((cement vert)⊗(cement cap)⊗ w5)) 
∘ (basic (w4⊗(cement cap)⊗(cement vert)))∘z1))" by metis
