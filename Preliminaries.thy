...
text{*this lemma tells us the number of incoming and outgoing strands of a composition of two wall*}
...
primrec domain_codomain_list:: "wall \<Rightarrow> int list" where
...
(*
definition well_defined_tangle::"wall \<Rightarrow> bool" where
...
(*
definition well_defined::"wall \<Rightarrow> bool" where
