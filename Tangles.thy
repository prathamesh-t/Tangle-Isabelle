...
text{*well-defined wall as a type called diagram. The morphisms Abs_diagram maps a well defined wall to 
...
text{*For a well defined diagram, the morphism Rep-diagram acts as an inverse of Abs_diagram- 
...
text{*The map Abs-diagram is injective*}
